...
namespace ECommerce.Repository.Migrations
{
    ...
    [Migration("20241108162812_add Favorite")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.Special_Offers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Core.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.Favorite", b =>
                {
                    ...
                    b.HasOne("E_Commerce.Core.Identity.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("E_Commerce.Core.Identity.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
